...
#include <lvx_to_pcd/third_party/rapidxml.hpp>
#include <lvx_to_pcd/third_party/rapidxml_utils.hpp>
...
LvxFileHandle::LvxFileHandle()
    : file_ver_(kLvxFileV1), device_count_(0), cur_frame_index_(0), cur_offset_(0), data_start_offset_(0), size_(0),
      mode_(0), state_(0)
{
