...
uint8_t* LivoxPointToPxyzrtl(uint8_t* point_buf, LivoxEthPacket* eth_packet, ExtrinsicParameter& extrinsic)
{
...
uint8_t* LivoxRawPointToPxyzrtl(uint8_t* point_buf, LivoxEthPacket* eth_packet, ExtrinsicParameter& extrinsic)
{
    LivoxPointXyzrtl* dst_point = (LivoxPointXyzrtl*)point_buf;
    uint32_t points_per_packet = GetPointsPerPacket(eth_packet->data_type);
...
uint8_t* LivoxSpherPointToPxyzrtl(uint8_t* point_buf, LivoxEthPacket* eth_packet, ExtrinsicParameter& extrinsic)
{
    LivoxPointXyzrtl* dst_point = (LivoxPointXyzrtl*)point_buf;
    uint32_t points_per_packet = GetPointsPerPacket(eth_packet->data_type);
...
uint8_t* LivoxExtendRawPointToPxyzrtl(uint8_t* point_buf, LivoxEthPacket* eth_packet, ExtrinsicParameter& extrinsic)
{
    LivoxPointXyzrtl* dst_point = (LivoxPointXyzrtl*)point_buf;
    uint32_t points_per_packet = GetPointsPerPacket(eth_packet->data_type);
...
uint8_t* LivoxExtendSpherPointToPxyzrtl(uint8_t* point_buf, LivoxEthPacket* eth_packet, ExtrinsicParameter& extrinsic)
{
    LivoxPointXyzrtl* dst_point = (LivoxPointXyzrtl*)point_buf;
    uint32_t points_per_packet = GetPointsPerPacket(eth_packet->data_type);
...
uint8_t* LivoxDualExtendRawPointToPxyzrtl(uint8_t* point_buf, LivoxEthPacket* eth_packet, ExtrinsicParameter& extrinsic)
{
    LivoxPointXyzrtl* dst_point = (LivoxPointXyzrtl*)point_buf;
    uint32_t points_per_packet = GetPointsPerPacket(eth_packet->data_type);
    LivoxExtendRawPoint* raw_point = reinterpret_cast<LivoxExtendRawPoint*>(eth_packet->data);
                                            ...
                                            ExtrinsicParameter& extrinsic)
{
    LivoxPointXyzrtl* dst_point = (LivoxPointXyzrtl*)point_buf;
    uint32_t points_per_packet = GetPointsPerPacket(eth_packet->data_type);
    LivoxDualExtendSpherPoint* raw_point = reinterpret_cast<LivoxDualExtendSpherPoint*>(eth_packet->data);
...
const PointConvertHandler to_pxyzi_handler_table[kMaxPointDataType] = {LivoxRawPointToPxyzrtl,
...
Lds::Lds(uint32_t buffer_time_ms, uint8_t data_src) : buffer_time_ms_(buffer_time_ms), data_src_(data_src)
{
