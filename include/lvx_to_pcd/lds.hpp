...
typedef uint8_t* (*PointConvertHandler)(uint8_t* point_buf, LivoxEthPacket* eth_packet, ExtrinsicParameter& extrinsic);

const PacketInfoPair packet_info_pair_table[kMaxPointDataType] = {
    {100, 100000, 10000, 1318}, {100, 100000, 10000, 918}, {96, 240000, 4167, 1362}, {96, 240000, 4167, 978},
    {96, 480000, 4167, 1362},   {48, 480000, 4167, 978},   {1, 100, 10000000, 42}};
